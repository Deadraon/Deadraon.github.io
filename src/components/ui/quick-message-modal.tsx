            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-1">
                ...
                <textarea
                  ...
                  required
                  className="w-full text-sm px-4 py-3 rounded-xl border border-white/10 bg-white/[0.02] focus:bg-white/[0.04] focus:outline-none focus:ring-1 focus:ring-purple-500/40 text-white placeholder-white/30 resize-none transition duration-200"
                />
              </div>
