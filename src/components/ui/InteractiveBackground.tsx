...
export function InteractiveBackground() {
    ...
    const render = () => {
      ...
      for (let i = 0; i < particles.length; i++) {
        ...
        if (distToMouse < maxDist) {
          ...
          gradient.addColorStop(0, p.color + (force * 0.35) + ")");
        ...
        ctx.shadowBlur = p.radius > 2.5 ? 12 : 0;
        ...
        for (let j = i + 1; j < particles.length; j++) {
          ...
          if (pdist < maxPdist) {
            const lineAlpha = (1 - pdist / maxPdist) * 0.18;
            ctx.beginPath();
            ctx.moveTo(p.x, p.y);
  ...
  return (
    <div
      ref={containerRef}
      className="fixed inset-0 pointer-events-none z-0 overflow-hidden select-none bg-[#070814]"
    >
      {/* 1. Base Rich Gradient Mesh */}
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(120,119,198,0.25),rgba(255,255,255,0))]" />

      {/* 2. Floating Morphing Aurora Glow Orbs */}
      <motion.div
        animate={{
          x: [0, 40, -30, 0],
          y: [0, -50, 30, 0],
        ...
        className="absolute -top-32 -left-32 w-[600px] h-[600px] rounded-full bg-gradient-to-tr from-purple-600/30 via-indigo-500/20 to-blue-600/25 blur-[130px] opacity-80"
      />
      ...
      <motion.div
        ...
        className="absolute top-[35%] -right-40 w-[650px] h-[650px] rounded-full bg-gradient-to-bl from-blue-600/25 via-cyan-500/20 to-violet-600/20 blur-[140px] opacity-75"
      />
      ...
      <motion.div
        ...
        className="absolute -bottom-40 left-[15%] w-[550px] h-[550px] rounded-full bg-gradient-to-tr from-pink-500/20 via-purple-600/20 to-indigo-600/20 blur-[130px] opacity-70"
      />

      {/* 3. Modern Interactive Tech Grid Lines (Linear/Vercel Style) */}
      <div 
      ...
      <div
        ...
        style={{
          ...
          background: `
            radial-gradient(
              650px circle at ${smoothMouse.x}px ${smoothMouse.y}px,
